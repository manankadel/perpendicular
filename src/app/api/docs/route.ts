...
const document = {
  ...
  paths: {
    ...
    "/api/integrations/gmail/sync": { post: { description: "Pull Gmail messages using the persisted history cursor, persist them, and pause matching enrolled rows on replies.", responses: { "200": { description: "Inbox synchronized." } } } },
    "/api/integrations/gmail/watch": { post: { description: "Register or renew the Gmail Pub/Sub watch. Requires GMAIL_PUBSUB_TOPIC on the Dell.", responses: { "200": { description: "Watch registered." } } } },
