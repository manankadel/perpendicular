...
function ListsView({ state, mutate, setShowList, setShowLead }: { state: WorkspaceState; mutate: Mutation; setShowList: (show: boolean) => void; setShowLead: (show: boolean) => void }) {
